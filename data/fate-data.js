...
function getScoreLevel(score) {
  if (score >= 90) return { label: '命运级缘分', emoji: '💖', level: 'S', color: '#FFC85C', desc: '上辈子一定拯救了银河系！' }
...
// ==================== 维度定义 ====================
const DIMENSIONS = {
  constellation: { name: '星座匹配', emoji: '⭐', color: '#FF7BA9' },
  name: { name: '姓名缘分', emoji: '✍️', color: '#9B6BFF' },
